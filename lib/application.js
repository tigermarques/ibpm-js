...
const processNamespace = require('./api/process')
...
class BPMInstance {
  constructor (config) {
    ...
    this.process = {
       ...
       * @param {string} bpdId - ID of the BPD that will be started
       * @param {object} options - To identify the correct snapshot to be used, you must specify one of the `snapshotId`, `branchId`, or `processAppId` properties
       * @param {string} options.snapshotId - The identifier of the snapshot that contains the business process definition. If `snapshotId` is specified, `branchId` and `processAppId`are ignored
       * @param {string} options.branchId - The identifier of the branch that contains the business process definition. If this parameter is specified, the tip snapshot of the specified branch is used. If `branchId` is specified, `processAppId` is ignored. Note that the `branchId` parameter is ignored on a Process Server environment because it refers to the tip snapshot of the specified branch
       * @param {string} options.processAppId - The identifier of the process application that contains the business process definition. If this parameter is specified, the tip (current) snapshot of the default branch (track) on Process Center or the default snapshot on Process Server of that process application is used
       * @param {object} parameters - Parameters to be passed to the new instance. Each key corresponds to a parameter, and the corresponding value will be the parameters's value
       ...
       */
      start: function (bpdId, options = {}, parameters = {}) {
        return processNamespace.start(bpmConfig, bpdId, options, parameters)
      }
    }
